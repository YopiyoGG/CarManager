...
public class Audi : PassengerCar
{
    ...
    public new string Brand { get => $"Изменилась марка машины: Audi{base.Brand}"; set => base.Brand = value; }
    ...
    public Audi(string type_of_drive, string car_Color, string BodyType, string SteeringWheel) : base(type_of_drive, car_Color, BodyType)
    {
